export default {
  ...
  description: {
    ...
    it: 'L'orda di Bloodlust valuta la libertà e la lealtà offre un posto per l'individualismo o anche il caos. Le loro difese si trovano in un regno desertico chiamato Headless Landing.'
  }
}
